...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		if(where == 'next') {
			...
			var selectedDay=parseInt((this.options.position.start).getDate(),10);
			var selectedMonth=parseInt((this.options.position.start).getMonth(),10)+1;
			var selectedYear=parseInt((this.options.position.start).getYear(),10)+1900;
