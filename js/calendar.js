...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		if(where == 'next') {
			...
			var selectedDay=parseInt((this.options.position.start).getDate());
			var selectedMonth=parseInt((this.options.position.start).getMonth())+1;
			var selectedYear=parseInt((this.options.position.start).getYear())+1900;
